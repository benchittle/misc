...
class Game:
    ...
    def start_level(self):
        ...
        self.sub = randomGen3.Sub(self, (0, 0), 5, 8)
       # print(self.sub)
        self.start_pos = (0, 0)#self.sub.find_by_tags("start")[0].rect.center
    ...
    def update(self):
        ...
        self.dp.fill(BLACK)
        #for tile in self.sub.iter_tiles():
        #    if tile is not None:
        #        pg.draw.rect(self.dp, (255, 255, 255), tile.rect)
