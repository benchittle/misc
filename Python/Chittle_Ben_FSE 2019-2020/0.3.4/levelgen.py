...
class Tile(pg.sprite.Sprite):
    def __init__(self, ship, row, col, *tags):
        super().__init__()
        self.game = ship.game
        self.game.all_sprites.add(self, layer=config.TILE_LAYER)
        self.ship = ship
        self.row = row
        self.col = col
...
class Room(pg.sprite.Sprite):
    def __init__(self, tile):
        super().__init__()
        self.game = tile.game
        self.game.all_sprites.add(self, layer=config.ROOM_LAYER)
        self.tile = tile
    ...
    def build(self):
        ...
        for loc, Kind in self.sides.items():
            Kind(self.game, self.placements[loc], self.walls)
...
class Corridor(pg.sprite.Sprite):
    ...
    def build(self):
        ...
        for loc, Kind in self.sides.items():
            ...
            Kind(self.game, self.placements[loc], self.walls, anchor=anchor)
